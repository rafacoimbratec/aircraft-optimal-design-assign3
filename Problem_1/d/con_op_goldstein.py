...
def run_optimization(x1_init, x2_init, label):
    ...
    # Set input defaults to resolve promotion ambiguity
...
# Run with initial guess (4, 2)
run_optimization(4.0, 2.0, 'initial_guess_(4,2)')

# Run with initial guess (1.8, 0.2)
run_optimization(1.8, 0.2, 'initial_guess_(1.8,0.2)')

# Run with initial guess (1.8, 0.2)
run_optimization(0, 1, 'initial_guess_(0,1)')
